...
class _PricingPageState extends State<PricingPage> {
  ...
  Widget priceCard(String title, String price, int index, String detail, bool isMobile) {
    return MouseRegion(
      onEnter: (_) {
        if (!isMobile) controller.hoveredIndex.value = index;
      },
      onExit: (_) {
        if (!isMobile) controller.hoveredIndex.value = -1;
      },
      child: GestureDetector(
        onTap: () {
          if (isMobile) {
        ...
        child: Obx(() {
          ...
          final isSelected = isMobile && controller.selectedPlanIndex.value == index;
          ...
          return AnimatedContainer(
            ...
            child: Padding(
              padding: EdgeInsets.symmetric(horizontal: isMobile ? 40 : 20.w, vertical: isMobile ? 47 : 33.h),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  SizedBox(height: 15.h),
                  Row(
                    children: [
                      SvgPicture.asset(kDots1Image, height: 51, width: 51),
                      SizedBox(width: 9.2),
                      Flexible(
                        child: Text(
                          "$title Support",
                          style: AppStyles.blackTextStyle().copyWith(
                            fontSize: isMobile ? 24 : 20.sp,
                            color: kBlackColor,
                          ),
                        ),
                      ),
                  ...
                  Row(
                    children: [
                      Text("\$ ", style: GoogleFonts.inter(fontSize: isMobile ? 18 : 18.sp, fontWeight: FontWeight.w600, color: kBlackColor)),
                      Text(price, style: GoogleFonts.inter(fontSize: isMobile ? 34 : 34.sp, fontWeight: FontWeight.w600, color: kBlackColor)),
                      Text("/ month", style: GoogleFonts.inter(fontSize: isMobile ? 18 : 18.sp, fontWeight: FontWeight.w600, color: kBlackColor)),
                    ],
                  ),
                  SizedBox(height: 32.h),
                  CustomButton(
                    title: "Subscribe",
                    onTap: () {},
                    height: isMobile ? 52 : 52.h,
                    textSize: isMobile ? 20 : 20.sp,
                    color: kBlackColor,
                    textColor: kWhiteColor,
                    fontWeight: FontWeight.w500,
                  ),
    ...
    return Padding(
      ...
      child: Column(
        children: [
                        ...
                        child: Center(
                          child: Text(
                            ...
                            style: AppStyles.blackTextStyle().copyWith(
                              fontSize: 18,
                              fontWeight: FontWeight.w500,
                              color: controller.selectedMonth.value == 0 ? kWhiteColor : kBlackColor,
                            ),
                          ),
                        ),
                      ),
                        ...
                        child: Center(
                          child: Text(
                            ...
                            style: AppStyles.blackTextStyle().copyWith(
                              fontSize: 18,
                              fontWeight: FontWeight.w500,
                              color: controller.selectedMonth.value == 1 ? kWhiteColor : kBlackColor,
                            ),
                          ),
                        ),
                      ),
          ...
          SizedBox(height: isMobile ? 39.h : 134.h),
          isMobile
              ? Column(
            children: [
              priceCard("Basic", "1", 0, "Start making a difference with just \$1/month.", true),
              SizedBox(height: 32.h),
              priceCard("Standard", "5", 1, "Help more people with a little extra support.", true),
              SizedBox(height: 32.h),
              priceCard("Premium", "10", 2, "Your generosity creates meaningful impact.", true),
              SizedBox(height: 32.h),
              priceCard("Champion", "20", 3, "Lead the change with our Highest level of support.", true),
            ],
          )
              : Row(
            children: [
              Expanded(child: priceCard("Basic", "1", 0, "Start making a difference with just \$1/month.", false)),
              SizedBox(width: 25.w),
              Expanded(child: priceCard("Standard", "5", 1, "Help more people with a little extra support.", false)),
              SizedBox(width: 25.w),
              Expanded(child: priceCard("Premium", "10", 2, "Your generosity creates meaningful impact.", false)),
              SizedBox(width: 25.w),
              Expanded(child: priceCard("Champion", "20", 3, "Lead the change with our Highest level of support.", false)),
            ],
          ),
          SizedBox(height: 19.h),
        ],
