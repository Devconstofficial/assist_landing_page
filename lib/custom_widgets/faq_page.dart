...
class _FaqSectionState extends State<FaqSection> {
  ...
  Widget build(BuildContext context) {
    return Container(
      color: kGreyShade5Color.withOpacity(0.12),
      child: Padding(
        padding: EdgeInsets.symmetric(vertical: 42.h,horizontal: 42.h),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          spacing: 30.h,
          children: [
            Center(child: Text("The Assist App - Frequently Asked Questions",style: AppStyles.blackTextStyle().copyWith(fontSize: 34.sp,fontWeight: FontWeight.w700),)),
  ...
  Widget customQuestion (question,answer){
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(question,style: AppStyles.blackTextStyle().copyWith(fontSize: 30.sp,fontWeight: FontWeight.w500),),
        SizedBox(height: 15.h,),
        Text(answer,style: AppStyles.blackTextStyle().copyWith(fontSize: 20.sp,fontWeight: FontWeight.w300),),
      ],
    );
  }
